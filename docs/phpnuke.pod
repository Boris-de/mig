...
phpWebThings sites.  (For simplicity I refer to these collectively as
...
PostNuke and phpWebThings users can add Mig to their menus like anything
else, just giving F<mig.php> as the target to load.
