...
F<mkGallery.pl> has not been tested under Microsoft Windows to my knowledge.
...
and typing E<quot>makeE<quot>.  When make is finished, there should be a
F<jhead> file, which you can copy to some other directory for safekeeping.
...
F<jhead> should be placed in the same directory as F<mkGallery.pl>.
