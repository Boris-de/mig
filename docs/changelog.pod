...
Releases and release-tags in the SCM will now be signed with GPG. You can find the current key at http://mig.sf.net/mig.asc
...
new PNG images (public domain) taken from http://tango.freedesktop.org/ Thanks to the people from the Tango Project.
