...
A feature has been added to optinally restore the old behavior regarding 'total_images'. If you set C<$showTotalImagesString = false> in your config, the total_images text will not be generated, which is effectivly the same behavior that existed between 1.4.0 and 1.5.2.
