...
=head2 Version 1.3.3 (NOT YET RELEASED)
...
This resulted in the new F<config.php> option C<$maxThumbRows>.  Right now,
...
would require rewriting a lot of code.  However, I may introduce a new
image sorting function later which addresses this and at the same time
