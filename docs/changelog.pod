...
simpler this way (one less file to worry about looking at).

Modified F<mkGallery> to look for F<jhead> in E<quot>.E<quot> - simplifies
...
and modular.  (If you check out CVS you can probably build a Mig tarball by
typing E<quot>C<make dist ver=x.y.z>E<quot> although you may have to change
the path to tar in F<Makefile>).
