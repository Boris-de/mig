...
The config option C<$suppressImageInfo> did not work anymore since 1.4.0. This is fixed now. Please note that this option is deprecated anyway and can easily be replaced with C<$fileInfoFormatString>.
