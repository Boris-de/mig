...
The access to the lang array was incorrect for 'total_images' resulting in this text (e.g.: "Showing images 21-40 of 47 total") not being displayed in the folder-view. This bug was introduced in 1.4.0, so it has been around for some time.
