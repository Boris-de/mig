...
unix, FTP, shell prompt, whatever).  Eliminated F<FTPinstall> document
since it is no longer necessary.

Changed language designation for Danish to E<quot>dkE<quot> instead of
E<quot>daE<quot> (I don't know what da is, but it's not Denmark).
...
reason for every Mig download to be almost half a meg.
...
Modified F<mkGallery> to look for jhead in its own directory.  Simplifies
