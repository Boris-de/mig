...
PHP-Nuke users: see the F<phpnuke> document.
...
directory to someplace on your system that makes sense to you.
...
same directory as F<mkGallery.pl>.
...
E<quot>mig-extrasE<quot> section in the project files listing).  After
