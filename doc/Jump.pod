...
=head2 WHAT IS A JUMP URL TAG AND HOW DOES IT WORK?
...
C<http://tangledhelix.com/gallery/index.php?pageType=folder&currDir=./Our%20House/Before%20We%20Redecorated>

At 105 characters long, and having tons of URL-encoded C<%xx> type things
in it, it's not a pretty URL to have to send someone.  But here's what you
can do.  Add a line to your F<mig.cfg> that adds to the Jump Map.  There's
an example of this in F<mig.cfg.default>.
...
Also see F<docs/Apache.txt> which has some nifty C<mod_rewrite> ideas to
have simpler URLs.
