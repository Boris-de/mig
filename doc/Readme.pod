...
The F<mkGallery> utility requires Perl and ImageMagick.  See
F<docs/Utilities.txt> for more information.  Perl and ImageMagick are not
required to use MiG itself; they are only required if you want to use
F<mkGallery> to create thumbnail images.
